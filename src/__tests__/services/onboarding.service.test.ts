...
describe('OnboardingService', () => {
  ...
  describe('saveExtraData', () => {
    ...
    it('should save extra data to localStorage with user-scoped key', () => {
      ...
      const savedData = localStorage.getItem(`tilia_onboarding_extra_${userId}`);
  ...
  describe('getExtraData', () => {
    ...
    it('should retrieve extra data from localStorage', () => {
      ...
      localStorage.setItem(
        `tilia_onboarding_extra_${userId}`,
    ...
    it('should return null for invalid JSON', () => {
      localStorage.setItem(`tilia_onboarding_extra_${userId}`, 'invalid-json{');
  ...
  describe('clearExtraData', () => {
    ...
    it('should remove extra data from localStorage', () => {
      ...
      expect(localStorage.getItem(`tilia_onboarding_extra_${userId}`)).toBeNull();
    });
