...
export function OnboardingStep({ 
  ...
  return (
    <div className="w-full flex flex-col items-center text-center px-4 py-6 sm:px-6">
      {/* Icon */}
      <div className="w-20 h-20 bg-gradient-to-br from-primary-muted to-primary-muted rounded-full flex items-center justify-center mb-6 transition-transform hover:scale-110">
