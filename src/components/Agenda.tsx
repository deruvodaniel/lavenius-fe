...
import { Clock, Video, MapPin, Plus, Edit2, ChevronLeft, ChevronRight } from 'lucide-react';
  ...
  return (
    <div className="p-8">
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          {/* Calendar Header con navegación */}
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center gap-3">
              <h2 className="text-gray-900 capitalize">{monthName}</h2>
              <button
                onClick={goToToday}
